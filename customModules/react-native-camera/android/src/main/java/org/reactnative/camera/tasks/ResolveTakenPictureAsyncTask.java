...
public class ResolveTakenPictureAsyncTask extends AsyncTask<Void, Void, WritableMap> {
    ...
    private /*byte[]*/ ArrayList<byte[]>  mImagesData;
    private ReadableMap mOptions;
    private File mCacheDirectory;
    private int mDeviceOrientation;
    private PictureSavedDelegate mPictureSavedDelegate;

    public ResolveTakenPictureAsyncTask(/*byte[]*/ ArrayList<byte[]>  imageData, Promise promise, ReadableMap options, File cacheDirectory, int deviceOrientation, PictureSavedDelegate delegate) {
        mPromise = promise;
        mOptions = options;
    ...
    private void loadBitmap(byte[] mImageData) throws IOException {
        if(mBitmap == null){
    ...
    protected WritableMap doInBackground(Void... voids) {
        ...
        android.util.Log.i("ReactNativeCam", "Resolve Picture Taken Started ");
        for (byte[] mImageData: mImagesData){
            //byte[] mImageData = mImagesData.next();
            ...
            try{
                ...
                android.util.Log.i("ReactNativeCam", "inside Resolve PictureTaken ");

        finalresponse.putArray("pictures", data);
