...
public class CameraView extends FrameLayout {
    ...
    private class CallbackBridge implements CameraViewImpl.Callback {
        ...
        @Override
        public void onPictureTaken(/*byte[]*/ ArrayList<byte[]> data, int deviceOrientation) {
            for (Callback callback : mCallbacks) {
                android.util.Log.i("ReactNativeCam", "inside picturetaken on CameraView");
    ...
    public abstract static class Callback {
         ...
         */
        public void onPictureTaken(CameraView cameraView, /*byte[]*/ ArrayList<byte[]> data, int deviceOrientation) {}
